...
/*
-- --------------------------------------------------------
CREATE TABLE IF NOT EXISTS `meishi_access` (
...
CREATE TABLE IF NOT EXISTS `meishi_node` (
...
CREATE TABLE IF NOT EXISTS `meishi_role` (
  `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `meishi_role_user` (
